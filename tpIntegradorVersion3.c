...
void main()
{
    ...
    do
    {
        ...
        do
        {
            ...
            while (i < 10) // Consultar while cambiar por for, en busqueda secuencial por Crasheo cuando se ingresa un usuario superior a 10 o numeros grandes
            {
        ...
        contadorIntentos = 3;
        if (listaClientes[nroCliente].estado != 0) // El mensaje de cuenta bloqueado debe figurar despues de ingresar la contraseña correcta VER -
        {
        ...
        if (contadorIntentos != 0 && listaClientes[nroCliente].estado != 0)
        {
            do
            {
                ...
                do
                {
                    ...
                    if (opcion == 1 || opcion == 2 || opcion == 3) // PARA CONTROLAR LA CANTIDAD DE OPERACIONES
                    {
                    ...
                    {
                    case 1:
                        // saldoAntesDeMovimiento = saldo; //                       A borrar
                        // saldo = //                                               A borrar
                    ...
                    case 5:
                        for (int i = 1; i <= operacionesMaximas; i++) // FANA - Controlar
                        {
